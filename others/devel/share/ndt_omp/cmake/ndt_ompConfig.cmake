...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/shiyang/advanced_car/src/ndt_omp)
  set(ndt_omp_DEVEL_PREFIX /home/shiyang/advanced_car/devel)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/shiyang/advanced_car/install)
...
if(NOT "/home/shiyang/advanced_car/src/ndt_omp/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/shiyang/advanced_car/src/ndt_omp/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'koide <koide@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shiyang/advanced_car/src/ndt_omp/${idir}'.  ${_report}")
    endif()
