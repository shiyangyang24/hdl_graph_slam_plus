...
(cl:ensure-generic-function 'utm-val :lambda-list '(m))
(cl:defmethod utm-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hdl_graph_slam-srv:utm-val is deprecated.  Use hdl_graph_slam-srv:utm instead.")
  (utm m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SaveMap-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'utm) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SaveMap-request>) istream)
  "Deserializes a message object of type '<SaveMap-request>"
    (cl:setf (cl:slot-value msg 'utm) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SaveMap-request>)))
  ...
  "a3e236cc7954aa7dee42049c77264d90")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SaveMap-request)))
  "Returns md5sum for a message object of type 'SaveMap-request"
  "a3e236cc7954aa7dee42049c77264d90")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveMap-request>)))
  ...
  (cl:format cl:nil "bool utm~%float32 resolution~%string destination~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveMap-request)))
  "Returns full string definition for message of type 'SaveMap-request"
  (cl:format cl:nil "bool utm~%float32 resolution~%string destination~%~%~%"))
